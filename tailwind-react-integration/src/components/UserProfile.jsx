...
function UserProfile() {
  return (
    ...
    <div className="user-profile">
      ...
      <img src="https://via.placeholder.com/150" alt="User"   className="w-24 h-24 md:w-36 md:h-36 rounded-full mx-auto"/>
      <h1 className="text-lg md:text-xl text-blue-800 font-semibold my-4">John Doe</h1>
